...
HD_PWD='C:/Users/Menino/Desktop/MEU/4ano/2semestre/CR/Aula4/part1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterFSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CounterFSM.tcl
