...
HD_PWD='C:/Users/Menino/Desktop/MEU/4ano/2semestre/CR/Aula2/part4/part4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testHex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testHex.tcl -notrace
