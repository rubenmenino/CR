...
HD_PWD='c:/users/menino/desktop/meu/4ano/2semestre/cr/aula77777/customdisplay/customdisplay.tmp/customdisplay_v1_0_project/CustomDisplay_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CustomDisplay_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CustomDisplay_v1_0.tcl
