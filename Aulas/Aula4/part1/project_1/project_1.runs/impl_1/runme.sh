...
HD_PWD='C:/Users/Menino/Desktop/MEU/4ano/2semestre/CR/Aula4/part1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterFSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CounterFSM.tcl -notrace
