...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../CustomPerith.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../CustomPerith.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"../../../../CustomPerith.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../CustomPerith.gen/sources_1/bd/mb_design/ipshared/d0f7"
}
